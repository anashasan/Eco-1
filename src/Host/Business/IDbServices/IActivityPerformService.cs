...
namespace Host.Business.IDbServices
{
    public interface IActivityPerformService
    {
        ...
        List<GetDailyReportDto> GetDailyReportByBranchId(int? branchId);
        void UpdateDailyReport(EditDailyReportDto dailyReport);
        EditDailyReportDto GetEditActivityReportById(int activityperformdetailId);
